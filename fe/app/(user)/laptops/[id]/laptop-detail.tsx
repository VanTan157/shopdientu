...
const LaptopDetail = ({ product }: { product: ILaptop }) => {
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-gray-200 text-sm sm:text-base">
          <div className="flex flex-col gap-3">
            ...
            <p>
              <strong className="text-cyan-300">CPU:</strong>{" "}
              {product.specifications.cpu}
            </p>
          </div>
          <div className="flex flex-col gap-3">
            <p>
              <strong className="text-cyan-300">GPU:</strong>{" "}
          ...
          <div className="flex flex-col gap-3">
            ...
            <p>
              ...
              {product.specifications.battery}Wh
            </p>
            <p>
              <strong className="text-cyan-300">Webcam:</strong>{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-200 text-sm sm:text-base">
          <div className="flex flex-col gap-3">
            ...
            <p>
              <strong className="text-cyan-300">Thẻ:</strong>{" "}
              {product.tags.join(", ")}
            </p>
          </div>
          <div className="flex flex-col gap-3">
